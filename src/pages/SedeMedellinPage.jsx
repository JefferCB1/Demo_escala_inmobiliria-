...
const SedeMedellinPage = () => {
    ...
    return (
        <main ref={mainRef} className="flex-1 relative z-10 w-full" role="main">
            <Helmet>
                <title>Sede Medellín - Escala Inmobiliaria | Propietarios y Arrendatarios</title>
                <meta name="description" content="Sede Medellín de Escala Inmobiliaria en Laureles. Líneas de atención para propietarios y arrendatarios, pagos en línea y servicios inmobiliarios." />
                <link rel="canonical" href="https://escalainmobiliaria.com.co/sede-medellin/" />
                <meta property="og:title" content="Sede Medellín - Escala Inmobiliaria" />
                <meta property="og:description" content="Sede Medellín de Escala Inmobiliaria en Laureles. Atención a propietarios y arrendatarios." />
                <meta property="og:url" content="https://escalainmobiliaria.com.co/sede-medellin/" />
                <meta property="og:type" content="website" />
                <meta property="og:image" content="https://escalainmobiliaria.com.co/og-image.jpg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content="Sede Medellín - Escala Inmobiliaria" />
                <meta name="twitter:image" content="https://escalainmobiliaria.com.co/og-image.jpg" />
                <script type="application/ld+json">{JSON.stringify({
                    "@context": "https://schema.org",
                    "@type": "RealEstateAgent",
                    "name": "Escala Inmobiliaria - Sede Medellín",
                    "description": "Sede Medellín de Escala Inmobiliaria, expertos en arrendamiento y administración de propiedades en Laureles.",
                    "url": "https://escalainmobiliaria.com.co/sede-medellin/",
                    "telephone": "+573009122101",
                    "address": {
                        "@type": "PostalAddress",
                        "streetAddress": "Calle 35 No 81 09 interior 201",
                    ...
                    "breadcrumb": {
                        ...
                        "itemListElement": [
                            ...
                            { "@type": "ListItem", "position": 2, "name": "Propietarios", "item": "https://escalainmobiliaria.com.co/" },
                            { "@type": "ListItem", "position": 3, "name": "Sede Medellín", "item": "https://escalainmobiliaria.com.co/sede-medellin/" }
                        ]
                    }
                })}</script>
            </Helmet>
            ...
            <section ref={heroRef} aria-label="Sede Medellín de Escala Inmobiliaria" className="relative w-full min-h-[60vh] flex items-center justify-center pt-28 sm:pt-32 pb-16 px-4 sm:px-6 overflow-hidden">
                <div className="absolute inset-0 z-0">
                    <img
                        ...
                        decoding="async"
                    />
                    <div className="absolute inset-0 bg-gradient-to-br from-emerald-900/90 via-teal-800/85 to-emerald-900/90"></div>
                </div>
                ...
                <div className="relative z-10 max-w-4xl w-full flex flex-col items-center text-center">
                    ...
                    <h1 className="sede-hero-text font-heading text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-white mb-6 leading-tight">
                        Sede <span className="text-emerald-300">Medellín</span>
                    </h1>
                    ...
                    <div className="sede-hero-text flex flex-wrap justify-center gap-3 mt-8">
                        ...
                        <a
                            href="https://wa.me/573009122101?text=Hola,%20necesito%20información%20sobre%20la%20sede%20Medellín"
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="Contactar sede Medellín por WhatsApp"
                            className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-3.5 bg-emerald-500 text-white rounded-full font-bold text-sm sm:text-base shadow-lg hover:bg-emerald-400 hover:-translate-y-0.5 transition-all"
                        >
            ...
            <article id="sede-content">
                ...
                <section className="sede-section opacity-0 translate-y-8 w-full py-16 sm:py-20 px-4 sm:px-6 bg-white" aria-labelledby="portales-heading">
                    <div className="max-w-5xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
                            {/* Arrendatarios */}
                            <a
                                href="https://simidocs.siminmobiliarias.com/base/simired/simidocsapi1.0/index.php?inmo=1145&tipo=2"
                                target="_blank"
                                rel="noopener noreferrer"
                                aria-label="Portal de arrendatarios sede Medellín"
                                className="group"
                            >
                                <BentoCard className="text-center hover:-translate-y-2 transition-all duration-500 bg-slate-50 border-gray-100 shadow-md group-hover:shadow-xl group-hover:border-emerald-200">
                            ...
                            {/* Propietarios */}
                            <a
                                href="https://simidocs.siminmobiliarias.com/base/simired/simidocsapi1.0/index.php?inmo=1145&tipo=1"
                                target="_blank"
                                rel="noopener noreferrer"
                                aria-label="Portal de propietarios sede Medellín"
                                className="group"
                            >
                                <BentoCard className="text-center hover:-translate-y-2 transition-all duration-500 bg-slate-50 border-gray-100 shadow-md group-hover:shadow-xl group-hover:border-emerald-200">
                            ...
                            {/* Pagos */}
                            <a
                                href="https://pagos.palomma.com/escalainmobiliariamedellin/auth/login"
                                target="_blank"
                                rel="noopener noreferrer"
                                aria-label="Plataforma de pagos en línea sede Medellín"
                                className="group"
                            >
                                <BentoCard className="text-center hover:-translate-y-2 transition-all duration-500 bg-slate-50 border-gray-100 shadow-md group-hover:shadow-xl group-hover:border-emerald-200">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                            <div>
                                ...
                                <h2 id="ubicacion-heading" className="text-3xl md:text-4xl font-heading font-extrabold text-escala-dark mb-6 tracking-tight">
                                    Visítanos en <span className="text-emerald-600">Laureles</span>
                                </h2>
                                <div className="space-y-4">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600 font-medium">Calle 35 No 81 09 interior 201, Laureles, Medellín, Antioquia</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-3">
                                        <div className="w-10 h-10 bg-emerald-100 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                                        ...
                                        <div>
                                            ...
                                            <a href="tel:+573009122101" className="text-emerald-600 font-bold text-lg hover:text-emerald-500 transition-colors">300 912 2101</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="relative">
                                <BentoCard className="relative overflow-hidden p-0 border-0 shadow-2xl">
                                    <iframe
                                        ...
                                        title="Ubicación de Escala Inmobiliaria Sede Medellín en Google Maps"
                ...
                {/* CTA */}
                <section className="sede-section opacity-0 translate-y-8 w-full py-16 sm:py-20 px-4 sm:px-6 bg-slate-50" aria-label="Agendar asesoría en sede Medellín">
                    <div className="max-w-4xl mx-auto text-center">
                        <BentoCard className="relative overflow-hidden bg-gradient-to-br from-emerald-700 to-teal-900 border-0 p-6 sm:p-10 md:p-16">
                            ...
                            <div className="relative z-10">
                                <h2 className="text-2xl sm:text-3xl md:text-4xl font-heading font-extrabold text-white mb-4 tracking-tight">
                                    Agenda tu visita en{' '}
                                    <span className="text-emerald-300">nuestra sede</span>
                                </h2>
                                <p className="text-emerald-100/80 font-medium max-w-xl mx-auto mb-8">
                                    Nuestro equipo en Laureles está listo para atenderte. Ven y conoce cómo podemos administrar y proteger tu inversión inmobiliaria.
                                </p>
                                <a
                                    href="https://wa.me/573009122101?text=Hola,%20quiero%20agendar%20una%20visita%20en%20la%20sede%20Medellín"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    aria-label="Agendar visita en sede Medellín por WhatsApp"
                                    className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-3.5 bg-white text-emerald-800 rounded-full hover:bg-emerald-50 hover:shadow-lg hover:-translate-y-0.5 transition-all font-bold text-sm sm:text-base shadow-md"
                                >
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                        <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z" />
                                    </svg>
...
export default SedeMedellinPage;
